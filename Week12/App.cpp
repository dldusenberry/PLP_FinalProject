...
bool App::OnInit() {
	MyFrame* frame = new MyFrame("Spin the Wheel v2.0", wxPoint(50, 50), wxDefaultSize);
	frame->Show(true);
	return true;
}
    ...
    : wxFrame(NULL, wxID_ANY, title, pos, size)
{
    ...
    canvas = new WheelApp(drawingPaneWithButtons, wxID_ANY, wxDefaultPosition, wxDefaultSize);
...
/*
bool App::OnInit() {
	VersionOne* versionOne = new VersionOne("Spin the Wheel v2.0");
